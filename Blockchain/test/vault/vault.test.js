...
describe('Vault test', () => {
    ...
    describe('Admin functions', async () => {
        ...
        it("Withdraws after a fund is raised successfully")
        it("Withdraws all funds if all rounds are finished")
        it("Withdraws multiple rounds if theres outstanding withdraws")
    });
