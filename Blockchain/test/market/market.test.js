...
//             await (await tokenManagerInstance.from(communityCreatorAccount).changeContributionTarget(anotherCommunityCreatorAccount.signer.address)).wait()
...
//                     let communityBalance = ethers.utils.formatUnits(await tokenManagerInstance.from(accounts[i].signer.address)
//                         .balanceOf(accounts[i].signer.address), 18);
...
//                     let balance = ethers.utils.formatUnits(await tokenManagerInstance.from(communityCreatorAccount.signer.address)
...
//                 );
//                 await tokenManagerInstance.from(anotherCommunityCreatorAccount.signer.address).transferFrom(
//                     communityCreatorAccount.signer.address,
//                     anotherCommunityCreatorAccount.signer.address,
//                     ethers.utils.parseUnits(`${defaultTokenVolume / 2}`, 18),
//                 );
